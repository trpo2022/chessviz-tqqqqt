...
start_table.o: src/chessviz/start_table.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/chessviz/start_table.c -o $(OBJCH)/start_table.o

check_rule.o: src/libchessviz/check_rule.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/libchessviz/check_rule.c -o $(OBJLB)/check_rule.o

eror_mes.o: src/libchessviz/eror_mes.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/libchessviz/eror_mes.c -o $(OBJLB)/eror_mes.o

move.o: src/libchessviz/move.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/libchessviz/move.c -o $(OBJLB)/move.o

print_table.o: src/libchessviz/print_table.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/libchessviz/print_table.c -o $(OBJLB)/print_table.o

main.o: src/chessviz/main.c
	gcc -c $(CFLAGS) $(CPFLAGS) src/chessviz/main.c -o $(OBJCH)/main.o
